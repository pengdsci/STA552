...
```{r fig.align='center', out.width="90%", fig.cap="Machine learning algorithm workflow" }
...
```{r fig.align='center', out.width="100%", fig.cap="Over-fitting vs under-fitting" }
...
```{r fig.align='center', out.width="70%", fig.cap="Supervised learning: regression and classification" }
...
```{r fig.align='center', out.width="70%", fig.cap="Unsupervised learning: Clustering and model-based clustering" }
...
```{r fig.align='center', out.width="40%", fig.cap="Semisupervised learning illustration" }
...
```{r fig.align='center', out.width="70%", fig.cap="Semisupervised learning illustration" }
...
```{r fig.align='center', out.width="95%", fig.cap="Illustration of imputation of missing values" }
...
```{r fig.align='center', out.width="90%", fig.cap="Illustration of feature engineering" }
...
```{r fig.align='center', out.width="99%", fig.cap="Illustration of cross validation" }
...
```{r fig.align='center', out.width="80%", fig.cap="Illustration of multiple linear regression modeling" }
...
```{r fig.align='center', out.width="60%", fig.cap="Illustration of logistic regression modeling" }
...
```{r fig.align='center', out.width="80%", fig.cap="Illustration of decision tree model" }
...
```{r fig.align='center', out.width="80%", fig.cap="Illustration of bootstrap aggregation (BAGGING)" }
...
```{r fig.align='center', out.width="80%", fig.cap="Illustration of support vector machine (SVM)" }
...
```{r fig.align='center', out.width="70%", fig.cap="Illustration of K-means clustering" }
...
```{r fig.align='center', out.width="100%", fig.cap="Illustration of principal component analysis" }
...
```{r fig.align='center', out.width="60%", fig.cap="Illustration of single layer neural network: perceptron" }
...
```{r fig.align='center', out.width="70%", out.height="60%", fig.cap="Illustration of Bayes framework" }
...
```{r fig.align='center', out.width="50%", out.height="35%", fig.cap="Illustration of K-earest neighborhood algorithm" }
...
```{r fig.align='center', out.width="100%", fig.cap="Illustration of Ensemble learning methods" }
