...
The above predictive errors show that the linear support vector machine outperforms non-linear RBF-kernel-based SVR and the ordinary least square regression models.
